(function (global, factory) {
	...
	(global['orchard-lane-media-player'] = factory());
	...
	/*global SignalBinding:false*/
	    ...
	    if(typeof undefined === 'function' && undefined.amd){ //AMD
	        undefined(function () { return signals; });
	...
	var CONST = {
	  ...
	  MEDIASOURCE_TYPES: MEDIASOURCE_TYPES,
	...
	var VjMediaSourceLoader = function () {
	    ...
	    return new bluebird_1(function (resolve, reject) {
	      ...
	      function _onXhrReadyStateChanged() {
	        if (xhr.readyState == xhr.DONE) {
	          ...
	          var _resp = new Uint8Array(xhr.response);
	          if (VERBOSE$1) {
	  ...
	  function indexRange(vo, url) {
	    ...
	    return _xhr(vo, url, null, _headers).then(function (resp) {
	      if (INDEX_CACHING) {
	...
	var ERROR_TYPES = CONST.ERROR_TYPES;


	var VERBOSE = true;
	var BUFFER_MARGIN = 4;
	var VjMediaSource = function () {
	  function VjMediaSource() {
	    var _this = this;

	    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
	    classCallCheck(this, VjMediaSource);
	    ...
	    //playback info
	    this.segDuration = 0, this.totalDuration = 0, this.newVoStarted = false, this.requestingNewVo = false, this.playOffset = 0, this.segmentIndex = 0, this.totalSegments = 0, this.paused = false, this.ended = false, this.currentCodec = "", this.skipCount = 0;
	    ////-----------------
	    //SETUP
	    ////-----------------
	    this._currentVo;
	    ...
	    this.videoElement.addEventListener("playing", function () {
	      ...
	      _this.videoPlayingSignal.dispatch();
	    });
	  ...
	  VjMediaSource.prototype._newMediaSource = function _newMediaSource() {
	    this.starting = true;
	  ...
	  VjMediaSource.prototype._onSourceError = function _onSourceError(e) {};

	  VjMediaSource.prototype._onSourceOpen = function _onSourceOpen(e) {
	    this.starting = false;
	  ...
	  VjMediaSource.prototype.newBufferSouce = function newBufferSouce(codecs) {
	    var _this2 = this;
	    ...
	    return new bluebird_1(function (resolve, reject) {
	      _this2._removeSourceBuffer().then(function () {
	        setTimeout(function () {
	          ...
	          _this2.sourceBuffer = _this2.mediaSource.addSourceBuffer('video/mp4; codecs="' + codecs + '"');
	          _this2.sourceBuffer.addEventListener('updatestart', _this2.onBufferUpdateStartBound);
	          _this2.sourceBuffer.addEventListener('updateend', _this2.onBufferUpdateEndBound);
	  ...
	  VjMediaSource.prototype.pause = function pause() {
	    this.videoElement.pause();
	  };

	  VjMediaSource.prototype.play = function play() {
	    this.videoElement.play();
	  };

	  VjMediaSource.prototype._onVideoEnded = function _onVideoEnded(e) {
	    if (VERBOSE) {
	      console.warn('Video Ended');
	    }
	  };

	  VjMediaSource.prototype._onTimeUpdate = function _onTimeUpdate() {
	  ...
	  VjMediaSource.prototype.stepBack = function stepBack() {
	    var amount = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;

	    var _target = this.videoElement.currentTime - amount;
	    this.videoElement.currentTime = _target;
	    console.log("back", _target);
	  };

	  VjMediaSource.prototype.stepForward = function stepForward() {
	    var amount = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
	  ...
	  VjMediaSource.prototype.setPlaybackRate = function setPlaybackRate(rate) {
	    this.videoElement.playbackRate = rate;
	  };

	  VjMediaSource.prototype.getReadyState = function getReadyState() {
	    return this.mediaSource.readyState;
	  };

	  VjMediaSource.prototype.setCurrentVideoId = function setCurrentVideoId(id) {
	    this.currentVideoId = id;
	  };

	  VjMediaSource.prototype.getCurrentVideoId = function getCurrentVideoId(id) {
	    return this.currentVideoId;
	  };

	  VjMediaSource.prototype.addVo = function addVo(currentVo) {
	    var _this3 = this;

	    return new bluebird_1(function (resolve, reject) {
	      if (_this3._addingSegment) {
	        return reject(new Error("Vo being added"));
	      }
	      _this3._addingSegment = true;

	      if (VERBOSE) {
	        console.log("CurrentCodec: ", _this3.currentCodec, "new codec:", currentVo.codecs);
	      }

	      _this3._currentVo = currentVo;

	      if (!_this3.currentCodec) {
	        Emitter.emit('audio:warn', "The codecs arnt equal");
	        _this3.newBufferSouce(currentVo.codecs).then(function () {
	          resolve(_this3._readyToAdd(currentVo));
	        });
	      } else {
	        if (_this3.sourceBuffer) {
	          if (VERBOSE) {
	            Emitter.emit('audio:log', "Sourcebuffer updating: " + _this3.sourceBuffer.updating);
	            Emitter.emit('audio:log', "Sourcebuffer mode: " + _this3.sourceBuffer.mode);
	          }
	          resolve(_this3._readyToAdd(currentVo));
	        } else {
	          Emitter.emit('audio:warn', "The codecs arnt equal");
	  ...
	  VjMediaSource.prototype._readyToAdd = function _readyToAdd(currentVo) {
	    this.setCurrentVideoId(currentVo.id);
	    this.mediaSource.duration = this.totalDuration;
	    return this._addSegment(currentVo);
	  };

	  VjMediaSource.prototype._onBufferSourceRemoved = function _onBufferSourceRemoved() {};
	  ////-----------------
	  //BUFFER HANDLERS
	  ////-----------------


	  VjMediaSource.prototype.onBufferUpdateStart = function onBufferUpdateStart() {
	  ...
	  VjMediaSource.prototype.onBufferUpdateEnd = function onBufferUpdateEnd() {
	  ...
	  VjMediaSource.prototype._addSegment = function _addSegment(currentVo) {
	    var _this4 = this;
	    ...
	    return this._trySettingOffset(this.currentVo, off).then(function () {
	      return VjMediaSourceLoader.indexRange(_this4.currentVo).then(function (initResp) {
	        return _this4._addInitReponse(_this4.currentVo, initResp).then(function () {
	          off = _this4.sourceBuffer.timestampOffset - _this4.currentVo['timestampOffset'];
	          return _this4._trySettingOffset(_this4.currentVo, off).then(function () {
	            return VjMediaSourceLoader.range(_this4.currentVo).then(function (rangeData) {
	              return _this4._addResponse(_this4.currentVo, rangeData).then(function () {
	                _this4._addingSegment = false;
	                return {
	                  totalDuration: _this4.totalDuration,
	                  duration: _this4.currentVo.duration
	                };
	              });
	            });
	          });
	  ...
	  VjMediaSource.prototype._trySettingOffset = function _trySettingOffset(vo, off) {
	    var _this5 = this;
	    ...
	    return new bluebird_1(function (resolve, reject) {
	      ...
	      _i = _this5._getInterval(_poll);
	    });
	  };

	  VjMediaSource.prototype._addInitReponse = function _addInitReponse(vo, initResp) {
	    var _this6 = this;
	    ...
	    return new bluebird_1(function (resolve, reject) {
	      ...
	      if (_this6._canUpdate() && _this6.sourceBuffer) {
	        _this6.sourceBuffer.removeEventListener('updatestart', _this6.onBufferUpdateStartBound);
	        _this6.sourceBuffer.removeEventListener('updateend', _this6.onBufferUpdateEndBound);
	        _this6.sourceBuffer.addEventListener('updateend', _onInitAdded);
	        _tryAppend();
	      } else {
	  ...
	  VjMediaSource.prototype._addResponse = function _addResponse(vo, resp) {
	    var _this7 = this;
	    ...
	    return new bluebird_1(function (resolve, reject) {
	      ...
	      if (VERBOSE) {
	        console.log("Got video response. Soundbuffer updating: " + _this7.sourceBuffer.updating);
	      }
	      ...
	      if (_this7._canUpdate() && _this7.sourceBuffer) {
	        ...
	        try {
	          ...
	          if (vo.seekValue) {
	            var _t = _this7.videoElement.currentTime + vo.seekValue;
	            //this.videoElement.currentTime = _t
	          }
	          if (VERBOSE) {
	            console.log("Added segment: ", vo.id, "Total duration:", _this7.totalDuration);
	          }
	          _this7.segmentAddedSignal.dispatch();
	        } catch (e) {
	          if (VERBOSE) {
	            /*
	  ...
	  VjMediaSource.prototype._getInterval = function _getInterval(func) {
	    var dur = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 100;
	  ...
	  VjMediaSource.prototype._canUpdate = function _canUpdate() {
	    return this.mediaSource.readyState === 'open' && !this.sourceBuffer.updating;
	  };

	  VjMediaSource.prototype._removeSourceBuffer = function _removeSourceBuffer() {
	    var _this8 = this;

	    return new bluebird_1(function (resolve, reject) {
	      if (_this8.sourceBuffer) {
	        _this8.sourceBuffer.removeEventListener('updateend', _this8.onBufferUpdateEndBound);
	        _this8.sourceBuffer.removeEventListener('updatestart', _this8.onBufferUpdateStartBound);
	        try {
	          _this8.sourceBuffer.remove(0, _this8.mediaSource.duration);
	        } catch (e) {}
	        _this8.mediaSource.removeSourceBuffer(_this8.mediaSource.sourceBuffers[0]);
	        _this8.sourceBuffer = null;
	        if (VERBOSE) {
	  ...
	  VjMediaSource.prototype.resetMediasource = function resetMediasource() {
	    var _this9 = this;
	    ...
	    return this._removeSourceBuffer().then(function () {
	      _this9.mediaSource.removeEventListener('error', _this9.onSourceErrorBound);
	      _this9.mediaSource.removeEventListener('sourceopen', _this9.onSourceOpenBound);
	      _this9.mediaSource = null;
	      _this9.sourceBuffer = null;
	      _this9.requestingNewVo = false;
	      _this9.enterFrameCounter = 0;
	      _this9.videoElement.currentTime = 0;
	      _this9.totalDuration = _this9.segDuration = _this9.playOffset = 0;
	      //this.waitingLine.push(this.currentVo)
	      return _this9._newMediaSource();
	    });
	  };

	  createClass(VjMediaSource, [{
	    key: "el",
	    get: function get$$1() {
	...
	*/
	...
	var MediaPlayer = function MediaPlayer(options) {
	  var mediaSource = new VjMediaSource({
...
//# sourceMappingURL=orchard-lane-media-player.js.map
